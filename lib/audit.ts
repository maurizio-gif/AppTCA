...
export const AZIONI_LOG: Record<string, string> = {
  ...
  evento_pagamento_confermato: 'Iscrizioni eventi: pagamento confermato',
  evento_prenotazione_annullata: 'Iscrizioni eventi: prenotazione annullata',
  evento_prenotazione_riaperta: 'Iscrizioni eventi: prenotazione riaperta',
  evento_prenotazione_eliminata: 'Iscrizioni eventi: prenotazione cancellata definitivamente',
