...
// Gestione di una richiesta Junior: e' rimasta al modello precedente la
// pipeline dell'opportunita' - qui non c'e' una trattativa da far avanzare,
// solo un contatto che e' stato seguito o non ancora. Gestito si'/no piu'
// una nota, punto.
export function GestioneGestito({
  id,
  gestito,
  gestitoDa,
  gestitoIl,
